...
class Animal_Wildlife_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $animal_wildlife_icon_changer_array = animal_wildlife_icon_changer_array();
                    foreach ($animal_wildlife_icon_changer_array as $Animal_Wildlife_Icon_Changer) {
                            $icon_class = $this->value() == $Animal_Wildlife_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($Animal_Wildlife_Icon_Changer).'"></i>
                            <span class="animal-wildlife-social-class">'.esc_attr($Animal_Wildlife_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function animal_wildlife_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'animal-wildlife-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'animal_wildlife_icon_customize_js' );

if(!function_exists('animal_wildlife_icon_changer_array')){
    function animal_wildlife_icon_changer_array(){
        return array("", 
        "fab fa-500px",
