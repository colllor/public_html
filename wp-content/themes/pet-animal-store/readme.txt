...
= 0.8 =
* Changed css for sidebar widget.
...
= 0.9.2 =
* Added show/hide single post author,comment no option.
* Added css for show/hide blog post date,author,comment no,time option.
* Update POT file.
