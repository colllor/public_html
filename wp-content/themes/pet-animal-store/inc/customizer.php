...
function pet_animal_store_customize_register( $wp_customize ) {
	...
	//About Section
		...
		$wp_customize->add_control('pet_animal_store_demo_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Demo</h3>Our premium version of Pet Animal Store has unlimited sections with advanced control fields. Dedicated support and no limititation in any field.<br> <a target='_blank' href='". esc_url('https://www.themescaliber.com/pet-animal-store/') ." '>View Demo</a>",
		...
		$wp_customize->add_control('pet_animal_store_forum_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Support</h3>Regarding any theme issue, we offer 24/7 support. You can get assistance from our support staff in resolving any problem. Please get in touch with us.<br><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/pet-animal-store/') ." '>Support Forum</a>",
			'section'=> 'pet_animal_store_about_theme'
		));
