<?php 
	...
	$pet_animal_store_custom_css .='.primary-navigation a:hover, .primary-navigation ul li a:hover, .primary-navigation ul.sub-menu a:hover, .primary-navigation ul.sub-menu li a:hover{';
	...
	$pet_animal_store_custom_css .='.primary-navigation ul.sub-menu a, .primary-navigation ul.sub-menu li a{';
	...
	$pet_animal_store_custom_css .='.primary-navigation ul.sub-menu li a:hover {';
