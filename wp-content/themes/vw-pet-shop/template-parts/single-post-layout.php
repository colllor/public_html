        ...
        <?php if( get_theme_mod( 'vw_pet_shop_single_postdate',true) == 1 || get_theme_mod( 'vw_pet_shop_single_author',true) == 1 || get_theme_mod( 'vw_pet_shop_single_comments',true) == 1 || get_theme_mod( 'vw_pet_shop_single_time',true) == 1) { ?>
            <div class="metabox">
                ...
                <?php if(get_theme_mod('vw_pet_shop_single_author',true)==1){ ?>
                    <span><?php echo esc_html(get_theme_mod('vw_pet_shop_single_post_meta_field_separator'));?></span> <span class="entry-author"><i class="<?php echo esc_attr(get_theme_mod('vw_pet_shop_single_author_icon','fas fa-user')); ?>"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span>
                <?php } ?>

                <?php if(get_theme_mod('vw_pet_shop_single_comments',true)==1){ ?>
                    <span><?php echo esc_html(get_theme_mod('vw_pet_shop_single_post_meta_field_separator'));?></span> <span class="entry-comments"> <i class="<?php echo esc_attr(get_theme_mod('vw_pet_shop_single_comments_icon','fas fa-comments')); ?>"></i><?php comments_number( '0 Comments', '0 Comments', '% Comments' ); ?> </span>
                <?php } ?>

                <?php if(get_theme_mod('vw_pet_shop_single_time',true)==1){ ?>
                  <span><?php echo esc_html(get_theme_mod('vw_pet_shop_single_post_meta_field_separator'));?></span> <span class="entry-time"> <i class="<?php echo esc_attr(get_theme_mod('vw_pet_shop_single_time_icon','fas fa-clock')); ?>"></i><?php echo esc_html( get_the_time() ); ?></span>
                <?php } ?>
            </div>
        <?php } ?>
    </div>
