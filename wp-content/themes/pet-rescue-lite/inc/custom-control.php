...
class Pet_Rescue_Lite_Custom_Control extends WP_Customize_Control {
...
class Pet_Rescue_Lite_Image_Radio_Control extends WP_Customize_Control {
    public function render_content() {
        ...
        <ul class="controls" id='pet-rescue-lite-img-container'>
            <?php
            foreach ($this->choices as $value => $label) :
                $class = ($this->value() == $value) ? 'pet-rescue-lite-radio-img-selected pet-rescue-lite-radio-img-img' : 'pet-rescue-lite-radio-img-img';
                ?>
